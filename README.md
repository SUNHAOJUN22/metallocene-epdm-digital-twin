...
当前发布契约为 **V6.4 / 0.7.4**。2026-05-22 V6.5 自动巡检将 UI 报告页 manifest 与 case package manifest 的旧 `V4` 元数据改为共享 `APP_VERSION`，避免外围导出版本漂移；该变更不修改数理方程、单位适配、ResidualSystem、benchmark 或 heavy task 触发策略。
