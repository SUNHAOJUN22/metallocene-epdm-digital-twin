...
- Added Aspen Plus/HYSYS coupling support through `epdm_sim/aspen_bridge.py`, including Aspen-ready stream export tables, component aliases, variable mapping, unit context sheets, import validation, reconciliation helpers, COM script template text and Excel report sheets.
