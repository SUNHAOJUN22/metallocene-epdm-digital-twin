...
### 文件: `audit_trail.py`
**模块描述**: Audit trail records for task and report reproducibility.
...
### 文件: `bayesian_doe.py`
**模块描述**: Uncertainty-driven constrained DOE ranking utilities.
...
### 文件: `benchmark_calibration.py`
**模块描述**: Benchmark calibration and data-gap scoring for V5.5.
...
### 文件: `benchmark_reconciliation.py`
**模块描述**: Benchmark reconciliation helpers for V6.4 industrial evidence.
...
### 文件: `benchmark_source_registry.py`
**模块描述**: Benchmark source registry and lineage checks for V5.7.
...
### 文件: `calibrated_property_models.py`
**模块描述**: Calibrated property-model registry helpers for V5.6.
...
### 文件: `calibration.py`
**模块描述**: Experiment-data calibration and DOE utilities for the EPDM digital twin.
...
### 文件: `calibration_data_package.py`
**模块描述**: Calibration data package validation for V6.3.
...
### 文件: `calibration_loop.py`
**模块描述**: Closed-loop calibration, identifiability, uncertainty and DOE helpers.
...
### 文件: `case_manager.py`
**模块描述**: Case and scenario management for the digital twin.
...
### 文件: `components.py`
**模块描述**: Component data models and loaders.
...
### 文件: `conservation.py`
**模块描述**: Conservation and closure checks for process simulation results.
...
### 文件: `constrained_window.py`
**模块描述**: Engineering-constrained process-window recommendation.
...
### 文件: `data_assimilation.py`
**模块描述**: Evidence-aware data assimilation helpers for V6.3.
...
### 文件: `data_lineage.py`
**模块描述**: Data-lineage records for benchmarks and calibration datasets.
...
### 文件: `data_lineage_graph.py`
**模块描述**: Data-lineage graph helpers for benchmarks and calibration datasets.
...
### 文件: `db.py`
**模块描述**: Local SQLite data warehouse for reproducible EPDM digital-twin runs.
...
### 文件: `digital_twin_3d.py`
**模块描述**: High-level 3D digital twin views and equipment detail helpers.
...
### 文件: `dimensional_checks.py`
**模块描述**: Simple dimensional and unit-conversion checks used by V4.6 reports.
...
### 文件: `dimensioned.py`
**模块描述**: Lightweight dimensioned values for unit-safe scientific checks.
...
### 文件: `doe_optimal.py`
**模块描述**: Feasible DOE recommendation helpers for parameter information gain.
...
### 文件: `dynamic_reactor.py`
**模块描述**: Dynamic stirred-tank and semi-batch reactor model for EPDM solution polymerization.
...
### 文件: `dynamic_residuals.py`
**模块描述**: Dynamic ODE residual time-series checks for V5.4.
...
### 文件: `dynamic_stability.py`
**模块描述**: Numerical stability checks for dynamic reactor profiles.
...
### 文件: `dynamic_template_reactor.py`
**模块描述**: Template-driven semi-batch dynamic reactor approximation.
...
### 文件: `engineering_checks.py`
**模块描述**: Chemical-engineering sanity checks for simulation results.
...
### 文件: `engineering_rules.py`
**模块描述**: Chemical-engineering trend rule registry and runner.
...
### 文件: `eos.py`
**模块描述**: Simplified cubic-EOS-inspired K-value helpers.
...
### 文件: `equation_binding.py`
**模块描述**: Bind equation registry records to implementation functions and trend checks.
...
### 文件: `equation_registry.py`
**模块描述**: Machine-readable equation registry for formulas and model audit.
...
### 文件: `equation_residual_coupling.py`
**模块描述**: Equation-residual-code coupling checks for V5.7.
...
### 文件: `equation_reverse_check.py`
**模块描述**: Reverse checks from implementation output back to equation-registry rules.
...
### 文件: `equation_tests.py`
**模块描述**: Equation-registry to code consistency checks.
...
### 文件: `equipment_3d.py`
**模块描述**: Plotly 3D equipment primitives and EPDM unit-operation sketches.
...
### 文件: `evidence_chain.py`
**模块描述**: Industrial evidence-chain governance for equation/residual/data lineage.
...
### 文件: `evidence_chain_score.py`
**模块描述**: Evidence-chain scoring helpers for V6.2 industrial confidence gates.
...
### 文件: `experimental_benchmark.py`
**模块描述**: Experimental and standard-case benchmark metadata for V5.4.
...
**模块描述**: Experiment data ingestion, normalization and quality checks.
...
### 文件: `feed_adapter.py`
**模块描述**: Template-aware feed stream construction and validation.
...
### 文件: `file_security.py`
**模块描述**: File-path safety and export metadata helpers.
...
### 文件: `flash.py`
**模块描述**: Flash unit operation using Rachford-Rice and Wilson K values.
...
### 文件: `flowsheet.py`
**模块描述**: Complete EPDM process flowsheet solver.
...
### 文件: `flowsheet_types.py`
**模块描述**: Data structures and types for the EPDM flowsheet solver.
...
### 文件: `fluid_props.py`
**模块描述**: Mixture fluid properties, viscosity calibration and pipe hydraulics.
...
### 文件: `governance_certificate.py`
**模块描述**: Model-governance certificate tables for V6.4 UI/report paths.
...
### 文件: `heat_balance.py`
**模块描述**: Reaction heat, cooling duty and heat-transfer calculations.
...
### 文件: `identifiability.py`
**模块描述**: Parameter identifiability diagnostics using finite-difference proxies.
...
### 文件: `industrial_data_package.py`
**模块描述**: Industrial calibration data package helpers for V6.4.
...
### 文件: `io_schema.py`
**模块描述**: Unified input/output schema metadata for core models.
...
### 文件: `kinetics.py`
**模块描述**: Polymerization kinetics for metallocene EPDM/EPM solution process.
...
### 文件: `kpi_adapter.py`
**模块描述**: Adapters from legacy flowsheet KPIs to template-aware KPI rows.
...
### 文件: `kpi_schema.py`
**模块描述**: Template-aware KPI schema and validation helpers.
...
### 文件: `layout_3d.py`
**模块描述**: 3D process-layout builder for the EPDM digital twin.
...
### 文件: `model_audit_report.py`
**模块描述**: Audit-grade model credibility report assembly.
...
### 文件: `model_confidence.py`
**模块描述**: Model confidence scoring for R&D digital-twin outputs.
...
### 文件: `model_confidence_certificate.py`
**模块描述**: Model confidence certificate for V6.3 evidence governance.
...
### 文件: `model_confidence_engine.py`
**模块描述**: Evidence-weighted model confidence engine for V6.0.
...
### 文件: `model_contracts.py`
**模块描述**: Generic model contracts for simulation modules.
...
### 文件: `model_graph.py`
**模块描述**: Equation-residual-data model traceability graph for V6.0.
...
### 文件: `model_registry.py`
**模块描述**: Model registry for merged process-simulator and digital-twin capabilities.
...
**模块描述**: Validation utilities for model contracts and registry entries.
...
### 文件: `numerics.py`
**模块描述**: Numerical stability helpers shared by model governance layers.
...
### 文件: `ode_diagnostics.py`
**模块描述**: Diagnostics for template ODE profiles and solver summaries.
...
### 文件: `ode_events.py`
**模块描述**: Reusable ODE event helpers for template dynamic reactors.
...
### 文件: `ode_jacobian.py`
**模块描述**: Finite-difference Jacobian helpers for template ODE stiff solvers.
...
### 文件: `ode_scaling.py`
**模块描述**: State scaling helpers and BDF readiness diagnostics for template ODEs.
...
### 文件: `optimizer.py`
**模块描述**: Process optimizer for target EPDM/EPM grades.
...
### 文件: `parameter_constraints.py`
**模块描述**: Physical parameter constraints for estimation, posterior and uncertainty.
...
### 文件: `parameter_estimation.py`
**模块描述**: Nonlinear parameter estimation and parameter-set version management.
...
### 文件: `pareto.py`
**模块描述**: Multi-objective process-window scan and Pareto frontier selection.
...
### 文件: `phase_equilibrium_constraints.py`
**模块描述**: Phase-equilibrium physical constraints and flash residual diagnostics.
...
### 文件: `plotting.py`
**模块描述**: Plotly visualization helpers.
...
### 文件: `plot_validation.py`
**模块描述**: Plotly figure validation for scientific visualization release gates.
...
### 文件: `polymer_props.py`
**模块描述**: Empirical polymer property models and grade matching.
...
### 文件: `posterior.py`
**模块描述**: Lightweight posterior sampling for R&D parameter uncertainty.
...
### 文件: `posterior_residual_filter.py`
**模块描述**: Residual acceptance filters for posterior and uncertainty samples.
...
### 文件: `preflight.py`
**模块描述**: Pre-run dimensional and physical input validation.
...
### 文件: `profile_alignment.py`
**模块描述**: Model-experiment dynamic profile alignment and residual metrics.
...
### 文件: `property_calibration.py`
**模块描述**: R&D property calibration utilities for viscosity and heat-release inputs.
...
### 文件: `property_confidence.py`
**模块描述**: Property source and confidence metadata.
...
### 文件: `property_models.py`
**模块描述**: Template-dispatched polymer property models.
...
### 文件: `property_model_bridge.py`
**模块描述**: Bridge calibrated property-model selection into calculation paths.
...
### 文件: `property_model_runtime.py`
**模块描述**: Runtime application of calibrated property models for V6.2.
...
### 文件: `property_model_selector.py`
**模块描述**: Calibrated property model selector for V6.0 flowsheet governance.
...
### 文件: `property_runtime_audit.py`
**模块描述**: Audit calibrated property-model runtime effects for V6.4.
...
### 文件: `property_runtime_context.py`
**模块描述**: Property runtime context for V6.3 calibrated-model execution.
...
### 文件: `reaction_templates.py`
**模块描述**: Reaction template metadata for extensible polymerization models.
...
### 文件: `reactor.py`
**模块描述**: Polymerization reactor models.
...
### 文件: `recipe.py`
**模块描述**: Recipe engine for dynamic semi-batch EPDM polymerization.
...
### 文件: `recycle_solver.py`
**模块描述**: Iterative recycle tear-stream solver for simplified EPDM flowsheets.
...
### 文件: `report_consistency.py`
**模块描述**: Report/repro-package metadata consistency checks.
...
### 文件: `repro_package.py`
**模块描述**: Audit-grade reproducibility package export/import.
...
### 文件: `residual_acceptance.py`
**模块描述**: Residual acceptance policies for calibration, DOE, optimizer and posterior.
...
### 文件: `residual_aware_decision.py`
**模块描述**: Residual-aware posterior, uncertainty and DOE decision helpers.
...
### 文件: `residual_aware_decision_engine.py`
**模块描述**: Unified residual-aware decision engine for V6.4.
...
### 文件: `residual_aware_doe.py`
**模块描述**: Residual-aware DOE candidate scoring for V6.2.
...
### 文件: `residual_aware_optimizer.py`
**模块描述**: Residual-aware optimizer objective helpers for V6.2.
...
### 文件: `residual_aware_sampling.py`
**模块描述**: Residual-aware sampling decisions for V6.3 posterior/DOE/optimizer paths.
...
### 文件: `residual_graph.py`
**模块描述**: Residual graph and suspected-source traceability for V6.0.
...
### 文件: `residual_objective.py`
**模块描述**: Residual-driven objective and filtering helpers for V5.4 gates.
...
### 文件: `residual_solver.py`
**模块描述**: Residual-driven closure helpers for V5.5.
...
### 文件: `residual_system.py`
**模块描述**: Conservation residual system used by V5.3 math-core gates.
...
### 文件: `rheology.py`
**模块描述**: Unified Newtonian and non-Newtonian rheology models.
...
### 文件: `safety.py`
**模块描述**: Thermal safety screening for R&D EPDM polymerization cases.
...
### 文件: `scaleup.py`
**模块描述**: Kettle scale-up and engineering similarity calculations.
...
### 文件: `scientific_benchmarks.py`
**模块描述**: Golden scientific benchmark runner for release-gate regression checks.
...
### 文件: `sensitivity.py`
**模块描述**: Sensitivity analysis helpers.
...
### 文件: `solubility.py`
**模块描述**: Henry-law style gas solubility correlations for EPDM solution polymerization.
...
### 文件: `state.py`
**模块描述**: Application state models for cached, modular simulation workflows.
...
### 文件: `state_vector.py`
**模块描述**: Template-driven dynamic reactor state-vector utilities.
...
### 文件: `streams.py`
**模块描述**: Material stream data structures.
...
### 文件: `surrogate.py`
**模块描述**: Physical-constraint surrogate models for fast process screening.
...
### 文件: `template_config.py`
**模块描述**: Template-aware process configuration adapters.
...
### 文件: `template_flowsheet.py`
**模块描述**: Template-aware process flowsheet adapter.
...
### 文件: `template_ode_rhs.py`
**模块描述**: Template-native ODE right-hand side for dynamic polymerization reactors.
...
### 文件: `thermo.py`
**模块描述**: Simplified thermodynamic models and optional thermo package detection.
...
### 文件: `thermo_calibration.py`
**模块描述**: Thermodynamic calibration helpers for Henry and flash correction factors.
...
### 文件: `thermo_consistency.py`
**模块描述**: Thermodynamic sanity and phase-split consistency checks.
...
### 文件: `time_series_data.py`
**模块描述**: Experimental time-series data import and validation.
...
### 文件: `transport_core.py`
**模块描述**: Transport and heat-transfer math-core checks.
...
### 文件: `ui_audit.py`
**模块描述**: Static UI workflow audit helpers.
...
### 文件: `ui_theme.py`
**模块描述**: High-end industrial digital-twin UI theme helpers for Streamlit.
...
### 文件: `ui_workflow.py`
**模块描述**: UI action registry for explicit, efficient task triggering.
...
### 文件: `uncertainty.py`
**模块描述**: Model-confidence and uncertainty analysis for EPDM digital-twin KPIs.
...
### 文件: `unitops.py`
**模块描述**: Unit operation abstractions for the EPDM process flowsheet.
...
### 文件: `units.py`
**模块描述**: Unit conversion and dimensional sanity checks.
...
### 文件: `utils.py`
**模块描述**: Shared utilities and unit conversions for the EPDM simulator.
...
### 文件: `validation_campaign.py`
**模块描述**: Engineering validation-campaign closure utilities.
...
### 文件: `validation_evidence.py`
**模块描述**: Evidence tables for model validation and audit confidence.
...
### 文件: `validity_envelope.py`
**模块描述**: Model validity-envelope checks for extrapolation governance.
...
### 文件: `workflow_wizard.py`
**模块描述**: R&D workflow wizard metadata and next-action guidance.
...
### 文件: `cfd\boundary.py`
**模块描述**: Boundary-condition objects for lightweight CFD and OpenFOAM export.
...
### 文件: `cfd\fem_solver.py`
**模块描述**: Optional FEniCSx solver facade.
...
### 文件: `cfd\fields.py`
**模块描述**: CFD field containers and scalar diagnostics.
...
### 文件: `cfd\fouling.py`
**模块描述**: Fouling-risk field calculations for EPDM CFD visualizations.
...
### 文件: `cfd\grid_convergence.py`
**模块描述**: CFD scalar-label and grid-convergence diagnostics.
...
### 文件: `cfd\mesh.py`
**模块描述**: Structured 2D meshes for lightweight CFD visualizations.
...
### 文件: `cfd\openfoam_export.py`
**模块描述**: OpenFOAM case skeleton export for downstream industrial CFD.
...
### 文件: `cfd\simple_solver.py`
**模块描述**: Built-in lightweight 2D CFD-style solver for EPDM process visualization.
...
### 文件: `cfd\transport.py`
**模块描述**: Lightweight finite-volume-style transport utilities.
...
### 文件: `cfd\visualization.py`
**模块描述**: Plotly visualization helpers for CFD/FEM-style results.
...
### 文件: `dynamic_core\adaptive_integrator.py`
**模块描述**: Adaptive integrator audit helpers for V6.4 dynamic models.
...
### 文件: `dynamic_core\adaptive_step_control.py`
**模块描述**: Adaptive step-control diagnostics for V6.3 dynamic models.
...
### 文件: `dynamic_core\dae_constraints.py`
**模块描述**: DAE-style dynamic constraints for V6.0 state diagnostics.
...
### 文件: `dynamic_core\event_certificates.py`
**模块描述**: Dynamic event certificate helpers.
...
### 文件: `dynamic_core\event_detection.py`
**模块描述**: Dynamic event detection helpers for V6.3.
...
### 文件: `dynamic_core\event_localization.py`
**模块描述**: Dynamic event localization helpers for V6.4.
...
### 文件: `dynamic_core\invariant_projection.py`
**模块描述**: Dynamic state invariant projection helpers.
...
### 文件: `dynamic_core\residual_feedback.py`
**模块描述**: Feed dynamic residuals back into solver diagnostics and fallback policy.
...
### 文件: `dynamic_core\residual_timeseries.py`
**模块描述**: Dynamic residual time-series helpers for report and gates.
...
### 文件: `dynamic_core\rhs_terms.py`
**模块描述**: RHS term diagnostics coupled to template ODE state derivatives.
...
### 文件: `dynamic_core\solver_decision.py`
**模块描述**: Residual-aware dynamic solver decision helpers for V6.1.
...
### 文件: `dynamic_core\solver_policy.py`
**模块描述**: Closed-loop dynamic solver policy for V6.2.
...
### 文件: `dynamic_core\stability_checks.py`
**模块描述**: Proof-style dynamic stability checks for template ODE profiles.
...
### 文件: `dynamic_core\state_invariants.py`
**模块描述**: Dynamic state invariant checks for V6.0.
...
### 文件: `dynamic_core\step_acceptance.py`
**模块描述**: Dynamic step acceptance helpers for V6.2 solver policy.
...
### 文件: `estimation\confidence.py`
**模块描述**: Confidence interval helpers for fitted parameters.
...
### 文件: `estimation\constraints.py`
**模块描述**: Parameter-constraint tables for calibration workflows.
...
### 文件: `estimation\fit_diagnostics.py`
**模块描述**: Fit diagnostics for residual-constrained calibration.
...
### 文件: `estimation\fit_runner.py`
**模块描述**: Small residual-aware fit runner facade.
...
### 文件: `estimation\objectives.py`
**模块描述**: Residual-aware objective helpers for calibration.
...
### 文件: `estimation\persistence.py`
**模块描述**: Calibration persistence metadata helpers.
...
### 文件: `estimation\physical_penalties.py`
**模块描述**: Physical penalty terms for residual-constrained estimation.
...
### 文件: `estimation\residuals.py`
**模块描述**: Data residual helpers for parameter estimation.
...
### 文件: `estimation\residual_constrained_fit.py`
**模块描述**: Residual-constrained parameter-estimation helpers for V5.6.
...
### 文件: `estimation\residual_objectives.py`
**模块描述**: Residual-objective helpers split from parameter-estimation workflows.
...
### 文件: `flowsheet_core\energy_closure.py`
**模块描述**: Flowsheet energy-closure helpers.
...
### 文件: `flowsheet_core\feed_builder.py`
**模块描述**: Template feed-building helpers.
...
### 文件: `flowsheet_core\kpi_builder.py`
**模块描述**: Template KPI builder wrappers.
...
### 文件: `flowsheet_core\kpi_projection.py`
**模块描述**: KPI projection helpers with physical bounds.
...
### 文件: `flowsheet_core\material_closure.py`
**模块描述**: Flowsheet material-closure helpers.
...
### 文件: `flowsheet_core\recycle.py`
**模块描述**: Recycle closure helper wrappers.
...
### 文件: `flowsheet_core\residual_builder.py`
**模块描述**: Flowsheet residual builder wrappers.
...
### 文件: `flowsheet_core\unit_residuals.py`
**模块描述**: Unit-operation residual helpers.
...
### 文件: `flowsheet_core\unit_sequence.py`
**模块描述**: Flowsheet unit-sequence metadata.
...
### 文件: `fluid_core\density.py`
**模块描述**: Density helpers.
...
### 文件: `fluid_core\heat_capacity.py`
**模块描述**: Heat-capacity helpers.
...
### 文件: `fluid_core\hydraulics.py`
**模块描述**: Hydraulic trend helpers.
...
### 文件: `fluid_core\property_selector_bridge.py`
**模块描述**: Fluid-core bridge to calibrated property selection.
...
### 文件: `fluid_core\transport_residuals.py`
**模块描述**: Transport residual helpers for fluid-core split.
...
### 文件: `fluid_core\viscosity.py`
**模块描述**: Viscosity helpers.
...
### 文件: `math_core\acceptance.py`
**模块描述**: Unified V5.7 model-acceptance helpers.
...
### 文件: `math_core\balance_laws.py`
**模块描述**: Balance-law helpers for the V6.0 industrial math core.
...
### 文件: `math_core\constraints.py`
**模块描述**: Physical-constraint aggregation for the V5.7 math core.
...
### 文件: `math_core\diagnostics.py`
**模块描述**: Top-level diagnostics for the layered V5.7 math core.
...
### 文件: `math_core\dimension_signatures.py`
**模块描述**: Dimension-signature validation for equation registry records.
...
### 文件: `math_core\equations.py`
**模块描述**: Equation-level math-kernel summaries.
...
### 文件: `math_core\equation_graph.py`
**模块描述**: Equation graph helpers for the V6.0 math core.
...
### 文件: `math_core\kinetic_identities.py`
**模块描述**: Kinetic identity helpers for V6.0 release gates.
...
### 文件: `math_core\model_confidence.py`
**模块描述**: V6.0 math-core confidence composition helpers.
...
### 文件: `math_core\residuals.py`
**模块描述**: Residual-level math-kernel helpers.
...
### 文件: `math_core\residual_graph.py`
**模块描述**: Residual graph helpers for the V6.0 math core.
...
### 文件: `math_core\thermodynamic_identities.py`
**模块描述**: Thermodynamic identities used by V6.0 science gates.
...
### 文件: `pages\calibration_page.py`
**模块描述**: Parameter set management and nonlinear estimation page components.
...
### 文件: `pages\case_manager_page.py`
**模块描述**: Case and scenario management page.
...
### 文件: `pages\cfd_page.py`
**模块描述**: CFD/FEM-style visualization page.
...
**模块描述**: Digital-twin dashboard page.
...
### 文件: `pages\dynamic_reactor_page.py`
**模块描述**: Dynamic batch/semi-batch reactor page.
...
### 文件: `pages\equipment_library_page.py`
**模块描述**: 3D equipment library page.
...
### 文件: `pages\experiment_data_page.py`
**模块描述**: Experiment data management page.
...
### 文件: `pages\heat_fluid_page.py`
**模块描述**: Heat balance, fluid properties and safety page.
...
### 文件: `pages\model_governance_page.py`
**模块描述**: Model governance and confidence-certificate page.
...
**模块描述**: Product properties and target-grade matching page.
...
### 文件: `pages\reactor_page.py`
**模块描述**: Reactor and kinetics page.
...
### 文件: `pages\report_page.py`
**模块描述**: Report export page.
...
### 文件: `pages\sensitivity_optimization_page.py`
**模块描述**: Sensitivity, single-objective optimization and Pareto page.
...
### 文件: `pages\separation_page.py`
**模块描述**: Separation, flash, recycle and thermodynamics page.
...
### 文件: `pages\workflow_wizard_page.py`
**模块描述**: Streamlit page for the V4.7 R&D workflow wizard.
...
### 文件: `reactor_core\heat_release.py`
**模块描述**: Reactor heat-release helper equations.
...
### 文件: `reactor_core\material_balance.py`
**模块描述**: Reactor material-balance helpers.
...
### 文件: `reactor_core\polymer_moments.py`
**模块描述**: Polymer moment sanity helpers.
...
### 文件: `reactor_core\rate_engine.py`
**模块描述**: Template rate-engine wrapper.
...
### 文件: `reactor_core\reaction_balance.py`
**模块描述**: Reactor material-balance helpers.
...
### 文件: `reactor_core\reactor_outputs.py`
**模块描述**: Reactor output table helpers.
...
### 文件: `reactor_core\reactor_residuals.py`
**模块描述**: Reactor residual report helpers.
...
### 文件: `reactor_core\stoichiometry.py`
**模块描述**: Stoichiometry helpers for template polymerization.
...
### 文件: `reporting\excel.py`
**模块描述**: Excel report export module.
...
### 文件: `reporting\word.py`
**模块描述**: Word report export module.
...
### 文件: `services\cache_keys.py`
**模块描述**: Stable cache-key helpers for simulation services.
...
**模块描述**: Report export service and Plotly image fallback helpers.
...
**模块描述**: Simulation orchestration service used by Streamlit pages.
...
**模块描述**: Lightweight long-task status service for Streamlit session state.
...
### 文件: `solver_core\bounded_solver.py`
**模块描述**: Bounded numerical update helpers.
...
### 文件: `solver_core\conservation_correction.py`
**模块描述**: Small-balance correction certificates for V6.1 conservation gates.
...
### 文件: `solver_core\conservation_jacobian.py`
**模块描述**: Finite-difference conservation Jacobian helpers for V6.3.
...
### 文件: `solver_core\conservation_solve_path.py`
**模块描述**: Conservation-constrained solve-path helpers for V6.2.
...
### 文件: `solver_core\constrained_solver.py`
**模块描述**: Constrained residual-aware solver helpers for V6.0.
...
### 文件: `solver_core\dae_solver.py`
**模块描述**: Lightweight DAE constraint diagnostics for dynamic reactor results.
...
### 文件: `solver_core\equation_oriented_solver.py`
**模块描述**: Equation-oriented conservation solve helpers for V6.3.
...
### 文件: `solver_core\fallback_policy.py`
**模块描述**: Fallback policy helpers for residual-aware solvers.
...
**模块描述**: Bounded nonlinear residual-loop helpers for V6.4.
...
### 文件: `solver_core\residual_minimizer.py`
**模块描述**: Residual minimization helpers with bounded corrections.
...
### 文件: `solver_core\residual_projection.py`
**模块描述**: Residual projection and acceptance helpers.
...
### 文件: `solver_core\solver_certificates.py`
**模块描述**: Solver certificate generation for V6.0 audit reports.
...
### 文件: `solver_core\solver_status.py`
**模块描述**: Solver status tabulation helpers.
...
### 文件: `solver_core\solve_path_integrator.py`
**模块描述**: Integrate V6.4 residual-loop diagnostics into solve-path certificates.
...
### 文件: `solver_core\stability_region.py`
**模块描述**: Dynamic stability-region summaries.
